...
<div class="space-y-4 mt-4">
	<div class="border-b-2 border-dashed border-black">
		...
		<div
			class="prose text-black mt-2 pb-4 prose-pre:rounded-none prose-pre:bg-gray-100 prose-pre:text-black prose-img:mx-auto prose-img:mb-1 prose-quoteless prose-blockquote:font-normal hover:prose-a:text-gray-500 relative"
		>
			{@html data.post.body}
		</div>
	</div>
